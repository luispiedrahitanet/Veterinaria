<?php
    ...
    include('bin/Cliente.php');

    $usuarios = new Cliente();
    $datos = $usuarios->get_Cliente();
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary mb-3 float-left">CLIENTES</h6>
            ...
            <table class="w-100 display table table-bordered table-hover row-border shadow-sm rounded" id="dtUsuarios">
                <thead>
                    <tr class="text-nowrap">
                        ...
                        <th><i class="fas fa-sort"></i> Fecha ingreso</th>
                        <th> Acción </th>
                    </tr>
                </thead>
                <tfoot>
                ...
                <tbody>
                    ...
                    echo "<tr>";
                    echo "<td>" . $registro['ced_cliente'] . "</td>";
                    echo "<td>" . $registro['cli_nombres'] . "</td>";
                    echo "<td>" . $registro['cli_apellidos'] . "</td>";
                    echo "<td>" . $registro['cli_celular'] . "</td>";
                    echo "<td>" . $registro['cli_email'] . "</td>";
                    echo "<td>" . $registro['cli_direccion'] . "</td>";
                    echo "<td>" . $registro['ciu_ciudad_depto'] . "</td>";
                    echo "<td>" . $registro['cli_fecha'] . "</td>";
...
$(document).ready(function() {
    ...
    $("#dtUsuarios tbody").on("click",".editarUsuario", function(){
        ...
        $.post("bin/ClienteFunciones.php",{ funcion:"ciudades"},(respuesta) => {
    ...
    $(".formEditarUsuario").submit(e=>{
        ...
        $.post("bin/ClienteFunciones.php",{ funcion: "editarUsuario",cedula,nombres,apellidos,celular,email,direccion,ciudad,contrasena },(respuesta)=>{
    ...
    $("#btnNuevo").click(function(){
        ...
        $("#cedula,#nombres,#apellidos,#celular,#email,#direccion,#ciudad,#contrasena").removeAttr("disabled");
        //titulo del modal
    ...
    $(".formNuevoUsuario").submit(e=>{
        ...
        $.post("bin/ClienteFunciones.php",{ funcion:"nuevoUsuario",cedula,nombres,apellidos,celular,email,direccion,ciudad,contrasena },(respuesta)=>{
    ...
    $("#cedula").change(function(){
        ...
        $("#existeUsuario").empty();
        $.post("bin/ClienteFunciones.php",{ funcion:"consultarUsuario", miUsuario },(respuesta) => {
    ...
    $(".formEliminarUsuario").submit(e=>{
        ...
        if( accion == "Eliminar") {
            ...
            $.post("bin/ClienteFunciones.php",{ funcion:"eliminar", cedula },(respuesta) => {
